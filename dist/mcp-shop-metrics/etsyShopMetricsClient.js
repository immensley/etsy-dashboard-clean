...
function buildMetricsUrl(shopId, options) {
...
export async function fetchShopMetrics(shopId, options = {}) {
    const normalized = shopId === null || shopId === void 0 ? void 0 : shopId.trim();
    if (!normalized) {
