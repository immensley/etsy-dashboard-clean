...
function buildUrl({ shopId, sectionId, limit, offset }) {
    ...
    const finalSection = sectionId !== null && sectionId !== void 0 ? sectionId : "";
...
export async function fetchSectionListings(params) {
    if (!params.shopId) {
