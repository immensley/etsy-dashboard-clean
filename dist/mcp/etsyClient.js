...
export async function fetchShopListings(shop_id, section_id, limit = 5) {
    ...
    const zenrowsUrl = `https://api.zenrows.com/v1/?apikey=${process.env.ZENROWS_API_KEY}&url=${encodeURIComponent(baseEtsyUrl)}&premium_proxy=true`;
